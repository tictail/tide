...
import NamespacedActions from '../src/namespacedActions'

let tideInstance

class TestAction extends NamespacedActions {}
...
describe('Actions', () => {
  ...
  describe('#init', () => {
    it('initializes all actions', () => {
      expect.assertions(2)
      const spy = jest.fn()
      class One extends NamespacedActions {
        constructor() {
          super(...arguments)
          spy('one')
        }
      ...
      class Two extends NamespacedActions {
        constructor() {
          super(...arguments)
          spy('two')
        }
  ...
  describe('#proxy methods', () => {
    ...
    it('get', () => {
      expect.assertions(1)
      initActions(tideInstance, {foo: class Foo extends NamespacedActions {
        test() {
...
class TestActions extends NamespacedActions {
  constructor() {
    super(...arguments)
...
describe('Namespaced actions', () => {
  ...
  describe('#updateGlobalState', () => {
    it('updates the global state', () => {
      const nextState = tide.getState().deleteIn(['marvel', 'characters', 0])
      actions.updateGlobalState(() => nextState)
      expect(tide.getState().getIn(['disney', 'characters']).size).toEqual(3)
      expect(tide.getState().getIn(['marvel', 'characters']).size).toEqual(2)
    })
